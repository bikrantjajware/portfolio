...
const Header = () => {
  const sectionStyle = 'rounded-lg p-2 my-6 hover:text-slate-800';
  const glassStyle =
    'h-full w-full bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-20 border border-gray-300 shadow-xl';
  return (
